...
If the strings are not of equal length then once one string is exhausted then the characters that would have come from that string are just omitted and it continues taking *every other* character from the remaining string.
